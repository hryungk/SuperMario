...
var deployJava = 
    function() {
      var l = {core:["id","class","title","style"],i18n:["lang","dir"],
      ...
      function h(){
        ...
        var x = "background-color: #ffffce;text-align: left;border: solid 1px #f0c000; padding: 1.65em 1.65em .75em 0.5em; font-family: Helvetica, Arial, sans-serif; font-size: 75%; bottom:0; left:0; right:0; position:fixed; margin:auto; opacity:0.9; width:400px;";
        ...
        var z = '<span style="'+w+'" onclick="this.parentElement.style.display=\'none\';">&times;</span><img src="https://java.com/js/alert_16.png"><div style="'+B+'"><p>'+y+"</p>";
      ...
      function a(x,F){
        var C = 0;
        var E = x.match(version_regex_with_family_modifier);
        if(E != null){
          if(F){
            return true
          }
          ...
          var D = deployJava.getJREs();
          for(var A = 0;A < D.length; ++A){
            if(deployJava.compareVersionToPattern(D[A],y,z,B)){
              return true
            }
          }
          return false
        } else {
          var w = "Invalid versionPattern passed to versionCheck: "+x;k("[versionCheck()] "+w);
          alert(w);
          return false
        }
      }
      ...
      function b(){
        ...
        if(w == "Edge" || deployJava.browserName2 == "Chrome" || (deployJava.browserName2 == "FirefoxNoPlugin" && !a("1.8*",false)) || deployJava.browserName2 == "NoActiveX"){
          return true
        }
        return false
      }
      ...
      var i = {debug:null,version:"20120801",firefoxJavaVersion:null,useStaticMimeType:false,myInterval:null,preInstallJREList:null,brand:null,locale:null,installType:null,EAInstallEnabled:false,EarlyAccessURL:null,oldMimeType:"application/npruntime-scriptable-plugin;DeploymentToolkit",mimeType:"application/java-deployment-toolkit",launchButtonPNG:q(),browserName:null,browserName2:null,getJREs:function(){
        ...
        if(!this.isPluginInstalled() || !this.getPlugin().installLatestJRE()){
          ...
          if(x == "MSIE"){
            ...
            if((x == "Netscape Family") && (w.indexOf("win32") != -1)){
              ...
              location.href = d(((this.locale != null)?("&locale=" + this.locale):"") + ((this.brand != null) ? ("&brand=" + this.brand):""))
            }
          }
          return false
        }
        ...
        for(var x = 0; x < navigator.mimeTypes.length; ++x){
          ...
          if(w != null){
            if(this.firefoxJavaVersion == null || this.compareVersions(w[1],this.firefoxJavaVersion)){
              this.firefoxJavaVersion=w[1]
            }
          }
        }
        ...
        var y;
        if(x == "MSIE"){
          y = '<object classid="clsid:8AD9C840-044E-11D1-B3E9-00805F499D93" width="0" height="0"><PARAM name="launchjnlp" value="'+z+'"><PARAM name="docbase" value="' + encodeURIComponent(B) + '"></object>'
        } else {
          if(x == "Netscape Family"){
            y = '<embed type="' + (this.useStaticMimeType?"application/x-java-applet;jpi-version=":"application/x-java-applet;version=") + this.firefoxJavaVersion+'" width="0" height="0" launchjnlp="'+z+'"docbase="'+encodeURIComponent(B)+'" />'
          }
        }
        ...
        k("The Deployment Toolkit no longer installs JRE. Method setInstallerType() is no-op. More Information on usage of the Deployment Toolkit can be found in the Deployment Guide at ://docs.oracle.com/javase/8/docs/technotes/guides/deploy/");
        return false
      }, setAdditionalPackages:function(w){
        k("The Deployment Toolkit no longer installs JRE. Method setAdditionalPackages() is no-op. More Information on usage of the Deployment Toolkit can be found in the Deployment Guide at ://docs.oracle.com/javase/8/docs/technotes/guides/deploy/");
        return false
        ...
        location.href = d(((this.locale != null)?("&locale=" + this.locale):"") + ((this.brand != null)?("&brand=" + this.brand):"") + ((this.installType != null)?("&type=" + this.installType):""));
        return false
        ...
        if((this.preInstallJREList.length != 0) && (w.lengt h!= 0) && (this.preInstallJREList[0] != w[0])){
          clearInterval(this.myInterval)
        }
